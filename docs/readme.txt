This Repo contains the code for Lattice, an Experimental Numerical computation Library i developed to get more familiar with Machine Learning below Model abstractions.
It is built on Numpy and still has a lot of computations and calculations done in pure Numpy for now. This initial version mainly contains native 32bit float, integer & 
